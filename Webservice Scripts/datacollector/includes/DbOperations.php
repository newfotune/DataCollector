<?php
    class DbOperations {
        ...
        public function createEntity($type_id, $user_id, $geolat, $geolong, $note) {
        ...
        public function addResturant($id, $brand) {
          $query = "INSERT INTO RESTURANT (entity_id, brand) VALUES ($id, '$brand')";
          //$stmt->bind_param("dsssss",$type_id,NOW(),$geolat,$geolong, $address, $note);
          $result = mysqli_query($this->con, $query)  or die ("Couldn't execute query: ".mysqli_error($this->con));
          if ($result) { return 1; }
          else { return 2; }
        ...
        public function addStopSign($id) {
          $query = "INSERT INTO STOP_SIGN (entity_id) VALUES ($id)";
          //$stmt->bind_param("dsssss",$type_id,NOW(),$geolat,$geolong, $address, $note);
          $result = mysqli_query($this->con, $query)  or die ("Couldn't execute query: ".mysqli_error($this->con));
          if ($result) { return 1; }
          else { return 2; }
        ...
        public function addTrafficLight($id) {
          $query = "INSERT INTO TRAFFIC_LIGHT (entity_id) VALUES ($id)";
          //$stmt->bind_param("dsssss",$type_id,NOW(),$geolat,$geolong, $address, $note);
          $result = mysqli_query($this->con, $query)  or die ("Couldn't execute query: ".mysqli_error($this->con));
          if ($result) { return 1; }
          else { return 2; }
        ...
        public function addTrafficCamera($id) {
          $query = "INSERT INTO TRAFFIC_CAMERA (entity_id) VALUES ($id)";
          //$stmt->bind_param("dsssss",$type_id,NOW(),$geolat,$geolong, $address, $note);
          $result = mysqli_query($this->con, $query)  or die ("Couldn't execute query: ".mysqli_error($this->con));
          if ($result) { return 1; }
          else { return 2; }
        ...
        public function addRoadConstruction($id) {
          $query = "INSERT INTO ROAD_CONSTRUCTION (entity_id) VALUES ($id)";
          //$stmt->bind_param("dsssss",$type_id,NOW(),$geolat,$geolong, $address, $note);
          $result = mysqli_query($this->con, $query)  or die ("Couldn't execute query: ".mysqli_error($this->con));
          if ($result) { return 1; }
          else { return 2; }
